...
const Navbar = () => {
  ...
  return (
    <div
      ...
      className="fixed w-full shadow-md z-[100] h-16 bg-white"
    >
      <div className="flex justify-between items-center px-7 py-3">
        <ul
          style={{ color: `${linkColor}` }}
          className="hidden md:flex text-md tracking-widest gap-40 items-center text-lg"
        >
          <div className="">
            <Image src={hello} width="150" height="200" />
          </div>
          <Link href="/#about">
            <li className="hover:scale-105 duration-100 text-transparent bg-clip-text bg-gradient-to-r from-purple-600 to-pink-600">
              About
            </li>
          </Link>
          <Link href="/#skills">
        ...
        {/* <BsFillMoonStarsFill
          className="cursor-pointer text-2xl hover:text-[#9C9CDD]"
      ...
      >
        <div
          className={
            nav
              ? "fixed left-0 top-0 w-[65%] sm:w-[50%] md:w-[25%] h-screen bg-[#ecf0f3] p-10 ease-in duration-500"
        ...
        >
          <div>
            <div className="flex flex-row-reverse w-full mb-12">
              <div
                onClick={toggleNav}
                className="shadow-sm shadow-gray-400 cursor-pointer p-2 rounded-full"
              >
