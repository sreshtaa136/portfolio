...
const Skills = () => {
    return (
        <div id='skills' className='max-w-[1240px] mx-auto px-2 py-8'>
            <div className='max-w-[1240px] flex flex-col justify-center h-full'>
                ...
                {/* FRAMEWORKS */}
                <h3 className='text-lg py-8 mb-3 mt-8 uppercase tracking-widest font-semibold text-transparent bg-clip-text bg-gradient-to-b from-purple-700 to-pink-600'>Frameworks</h3>             
                <div className='grid md:grid-cols-2 lg:grid-cols-5 gap-8'>
